...
import numpy as np
import pickle
from labs_model2 import run_labs,lab_name_dict, calculate_statistics, convert_unit
...
#     merged_df = merged_df.dropna(how='any')
    ...
    final_stat_df = cond_table[['chai_patient_id','line_start']].drop_duplicates()
    ...
    for lab in run_labs:
        ...
        final_stat_df = final_stat_df.merge(statistics_df, on=["chai_patient_id","line_start"], how="left")
